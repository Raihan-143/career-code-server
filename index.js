...
async function run() {
    try {
        ...
        //connect two collection without aggregate
        ...
        //using patch method for getting viewApplicant details
...
app.listen(port, () => {
    console.log(`Career code is running on portal:${port}`)
})